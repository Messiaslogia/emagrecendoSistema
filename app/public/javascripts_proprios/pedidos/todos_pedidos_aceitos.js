   ...
   await fetch(url)
        ...
        .then( data => {
            ...
            data.forEach((pedido, index) => {
                ...
                // Pega o primeiro Indice e verifica seu status e atualiza a variavel de comparação
                if(index == 0){
                    ...
                    if(pedido.numero_do_pedido != data[indexAnterior].numero_do_pedido){ // Verifica se vai repetir o pedido

                        if(pedido.status == 'Pago!'){ // seu status
                            div_pedidos.innerHTML += `
                                <tr>
                                    <td>
                                        <div class="d-flex px-2 py-1">
                    ...
                    }else{ // Por alguma bruxaria a primeira verificação de repetição falhou, então faço novamente
