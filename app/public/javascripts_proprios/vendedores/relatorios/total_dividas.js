        ...
        div_dividas.innerHTML += `
                                 <tr>
                                      ...
                                      <td class="align-middle">
                                          <a class="btn btn-link text-danger text-gradient px-3 mb-0" href="/apiDividas/deletarDividaVendedor/${divida.id_divida}"><i
                                              class="material-icons text-sm me-2">delete</i>Deletar</a>
                                          <a class="btn btn-link text-dark px-3 mb-0" href="/apiDividas/editarDividaFormVendedor/${divida.id_divida}"><i class="material-icons text-sm me-2">edit</i>Editar</a>
                                      </td>
                                 </tr>
                         `
    });
